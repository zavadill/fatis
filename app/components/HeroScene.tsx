      ...
      <div className="relative w-full min-h-[90vh] lg:min-h-screen flex flex-col-reverse lg:flex-row items-center justify-between pb-10 lg:pb-0">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center px-6 py-10 lg:p-8 lg:pl-24 text-left z-10 lg:pt-0">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
            <button className="w-full sm:w-auto px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-full transition-all transform hover:scale-105 shadow-lg shadow-blue-600/20 ring-1 ring-blue-500/50 text-center">
              Chci termín
            </button>
            <button className="w-full sm:w-auto px-8 py-4 border border-neutral-800 hover:border-neutral-600 bg-neutral-900/50 hover:bg-neutral-800 text-white rounded-full transition-all backdrop-blur-sm text-center">
              Ceník služeb
            </button>
          </div>
        </div>
