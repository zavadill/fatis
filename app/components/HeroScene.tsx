...
const HeroScene = () => {
  return (
    <section className="relative bg-neutral-950 overflow-hidden text-neutral-100 selection:bg-blue-500 selection:text-white">
      ...
      {/* 1. DEKORATIVNÍ POZADÍ (Glow effect nahoře vpravo) */}
      ...
      {/* 2. JEMNÁ MŘÍŽKA NA POZADÍ (Pro texturu) */}
      ...
      <div className="relative w-full min-h-[90vh] lg:min-h-screen flex flex-col-reverse lg:flex-row items-center justify-between pb-10 lg:pb-0">
        ...
        {/* LEVÁ SEKCE – TEXT */}
        <div className="w-full lg:w-1/2 flex flex-col justify-center px-6 py-10 lg:p-8 lg:pl-24 text-left z-10 lg:pt-0 pt-32">
      ...
      <div className="relative z-20 -mt-12 lg:-mt-32 pb-24 px-4 sm:px-6">
        ...
        {/* 3. GLOW EFEKT POD KARTOU (Aby to nebylo ve tmě) */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-3xl h-[400px] bg-blue-900/20 blur-[120px] rounded-full pointer-events-none" />

        {/* 4. VELKÝ VODOZNAK POD KARTOU (Vyplní prázdno) */}
        ...
        <div className="max-w-5xl mx-auto relative">
          ...
          <div className="bg-neutral-900/80 backdrop-blur-xl rounded-2xl sm:rounded-3xl border border-neutral-800 shadow-2xl shadow-black/50 p-5 sm:p-10 overflow-hidden relative">
            ...
            {/* HLAVIČKA KARTY */}
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-4 mb-6 sm:mb-8 relative z-10">
            ...
            {/* IFRAME KONTEJNER */}
            <div className="w-full overflow-hidden rounded-xl sm:rounded-2xl border border-neutral-800 bg-white/5 relative group z-10">
             ...
             <p className="text-center text-neutral-600 text-[10px] sm:text-xs mt-4 relative z-10">
