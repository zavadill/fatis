          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
            ...
            <div className="lg:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-8 lg:gap-4">
                ...
                <div className="flex flex-col gap-4">
                    <h3 className="font-bold text-white mb-2">Sociální sítě</h3>
                    <FooterLink href="/sluzby">Facebook</FooterLink>
                    <FooterLink href="/galerie">Instagram</FooterLink>
                </div>
                
                <div className="flex flex-col gap-4">
                    <h3 className="font-bold text-white mb-2">Odkazy</h3>
